        ...
        <table width="620" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:24px; color:#989797;">
            ...
            <tr>
                <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td align="center" valign="middle" style="background-color:#f8f8f8; height:120px;"><img src="<?= $logoimage ?>" alt="" /></td>
                        </tr>
                    </table></td>
            </tr>
            <tr>
                <td valign="top" style="padding-top:90px; padding-bottom:30px;">
                    <?= $messegedata ?>
                </td>
            </tr>
            <tr>
                <td valign="top" style="border-top:#ebebeb solid 1px; padding-top:30px; padding-bottom:30px; text-align:center; color:#989797; font-size:14px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td style="text-align:center; color:#989797;">Copyright © <?php echo date('Y');?> FitMakersLive , All rights reserved.</td>
                        </tr>
                        <tr>
                            <td height="20"></td>
                        </tr>
                        <tr>
                            <td style="text-align:center; color:#989797;">You are receiving this email because you have signed up to FitMakersLive</td>
                        </tr>
                        <tr>
                            <td height="20"></td>
                        </tr>
                        ...
                        <tr>
                            <td style="text-align:center; color:#989797;"><a href="mailto:support@fitmakerslive.com" target="_blank" style="color:#989797; text-decoration:none;">support@fitmakerslive.com</a></td>
                        </tr>
                        <tr>
                            <td height="20"></td>
                        </tr>
