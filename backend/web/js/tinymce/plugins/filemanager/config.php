...
$root = $_SERVER['DOCUMENT_ROOT'] . '/fitmakerslive/Source/development/PHP/backend/web'; // don't touch this configuration
...
$base_url= 'http://' . $_SERVER['HTTP_HOST'] . '/fitmakerslive/Source/development/PHP/backend/web'; //url base of site if you want only relative url leave empty
$upload_dir = '/../../uploads/cms'; // path from base_url to upload base dir
