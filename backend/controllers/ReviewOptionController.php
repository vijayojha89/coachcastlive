...
use common\models\ReviewOptionSearch;
...
/**
 * ReviewOptionController implements the CRUD actions for ReviewOption model.
 */
class ReviewOptionController extends Controller
{
   ...
   public function beforeAction($action) {
        ...
        $auth_item = 'ReviewOptionController';
    ...
    /**
     * Lists all ReviewOption models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ReviewOptionSearch();
        ...
        /**
     * Displays a single ReviewOption model.
     * @param integer $id
     * @return mixed
     */
    public function actionView($id)
    {
     ...
     /**
     * Creates a new ReviewOption model.
...
//        $model->created_date = date("Y-m-d H:i:s");
        ...
        //$model->scenario = 'review-optionCreate';
    ...
    /**
     * Updates an existing ReviewOption model.
...
//        $model->modified_date = date("Y-m-d H:i:s");
        ...
        //$model->scenario = 'review-optionUpadte';
    ...
    */
    ...
    /**
     * Deletes an existing ReviewOption model.
    ...
    /**
     * Finds the ReviewOption model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ReviewOption the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ReviewOption::findOne($id)) !== null) {
            return $model;
        } else {
