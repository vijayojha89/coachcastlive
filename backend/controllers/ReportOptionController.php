...
use common\models\ReportOptionSearch;
...
/**
 * ReportOptionController implements the CRUD actions for ReportOption model.
 */
class ReportOptionController extends Controller
{
   ...
   public function beforeAction($action) {
        ...
        $auth_item = 'ReportOptionController';
    ...
    /**
     * Lists all ReportOption models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ReportOptionSearch();
        ...
        /**
     * Displays a single ReportOption model.
     * @param integer $id
     * @return mixed
     */
    public function actionView($id)
    {
     ...
     /**
     * Creates a new ReportOption model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new ReportOption();
//        $model->created_by = \Yii::$app->user->identity->id;
//        $model->created_date = date("Y-m-d H:i:s");
       
        //$model->scenario = 'report-optionCreate';
    ...
    /**
     * Updates an existing ReportOption model.
...
//        $model->modified_date = date("Y-m-d H:i:s");
        ...
        //$model->scenario = 'report-optionUpadte';
    ...
    */
    ...
    /**
     * Deletes an existing ReportOption model.
    ...
    /**
     * Finds the ReportOption model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ReportOption the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ReportOption::findOne($id)) !== null) {
            return $model;
        } else {
