...
<div class="rolesallocation-form">
        ...
        <div class="md-col-12">
            <div class="form-group">
                <label class="control-label" for="tickets-project_id"><?php 
                 $queryRole = "SELECT * from roles where id=".$_REQUEST['id']." and status = 0";
    ...
    $resCheckforEdit = yii\helpers\ArrayHelper::getColumn(\common\models\Rolesallocation::find()->select('action_id')->where(["role_id"=>$_REQUEST['id']])->All(), 'action_id');
    ...
    ?>
     <div class="col-lg-12">
        ...
        <th>
         ...
         <?php
            $query = "SELECT * from auth_items where parent_auth_item_id=".$authitems['auth_items_id']." and status = 0";
...
<?php echo $form->field($model, 'role_id')->hiddenInput(['value' => $_REQUEST['id']])->label(false);?>
    <?php ActiveForm::end(); ?>
