...
?>
<?php Pjax::begin(); ?><div class="qualification-index">
            ...
            ['class' => 'kartik\grid\ActionColumn',
             'template' => '{is-active} {update} {delete}',
                ...
                return Html::a('', 'index'.$string, [                                                  
                    ...
                    return Html::a('',['update', 'id'=>  common\components\GeneralComponent::encrypt($model->qualification_id)],
				      ['class'=>'glyphicon glyphicon-pencil', 'data-pjax'=>0]);
            }, 
                            'delete' => function ($url, $model) {
                    return Html::a('', ['delete', 'id'=>  common\components\GeneralComponent::encrypt($model->qualification_id)], ['class'=>'glyphicon glyphicon-trash',
