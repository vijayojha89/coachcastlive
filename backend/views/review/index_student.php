...
$data = $mnl->get_review_option('student');
...
$this->title = Yii::t('app', 'Student Reviews');
...
<!--    <h1><?= Html::encode($this->title) ?></h1>-->
    ...
    <?= GridView::widget([
        ...
        'panel' => [            
            'heading' => 'View',            
            'before' =>/* Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create-student-review'],
            ['class' => 'btn btn-success']) . ' ' . 
             * 
             */                
            Html::a('<i class="glyphicon glyphicon-refresh"></i>', ['student-review'], ['class' => 'btn btn-info']),
...
[
            ...
            ['class' => 'kartik\grid\ActionColumn',
             'template' => '{is-active} {update} {delete}',
                ...
                return Html::a('', 'student-review'.$string, [                                                  
                            'class'=>$icon,'onClick'=>'active_deactive(\''.$url.'\')',                                  
                ]);
            },
                            'update' => function ($url, $model) {
                    return Html::a('',['update-student-review', 'id'=>  common\components\GeneralComponent::encrypt($model->review_id)],
				      ['class'=>'glyphicon glyphicon-pencil', 'data-pjax'=>0]);
            }, 
                     'delete' => function ($url, $model) {
                    return Html::a('', ['delete-student', 'id'=>  common\components\GeneralComponent::encrypt($model->review_id)], ['class'=>'glyphicon glyphicon-trash',
