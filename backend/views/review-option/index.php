...
/* @var $searchModel common\models\ReviewOptionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Review Options');
$this->params['breadcrumbs'][] = $this->title;
?>
<?php Pjax::begin(); ?><div class="review-option-index">
            ...
            ['class' => 'kartik\grid\ActionColumn',
             'template' => '{update}',
                ...
                return Html::a('', 'index'.$string, [                                                  
                    ...
                    return Html::a('',['update', 'id'=>  common\components\GeneralComponent::encrypt($model->review_option_id)],
				      ['class'=>'glyphicon glyphicon-pencil', 'data-pjax'=>0]);
            }, 
                            'delete' => function ($url, $model) {
                    return Html::a('', ['delete', 'id'=>  common\components\GeneralComponent::encrypt($model->review_option_id)], ['class'=>'glyphicon glyphicon-trash',
