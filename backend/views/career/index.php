...
?>
<?php Pjax::begin(); ?><div class="career-index">
...
[
                ...
                'filter' => Html::activeDropDownList($searchModel, 'department',
                                Yii::$app->params['career_category'], ['class' => 'form-control', 'prompt' => 'Select...']),
            ],
[
                'attribute' => 'title',
                'enableSorting'=>FALSE,
            ...
            ['class' => 'kartik\grid\ActionColumn',
             'template' => '{is-active} {update} {delete}',
                ...
                return Html::a('', 'index'.$string, [                                                  
                    ...
                    return Html::a('',['update', 'id'=>  common\components\GeneralComponent::encrypt($model->career_id)],
				      ['class'=>'glyphicon glyphicon-pencil', 'data-pjax'=>0]);
            }, 
                            'delete' => function ($url, $model) {
                    return Html::a('', ['delete', 'id'=>  common\components\GeneralComponent::encrypt($model->career_id)], ['class'=>'glyphicon glyphicon-trash',
