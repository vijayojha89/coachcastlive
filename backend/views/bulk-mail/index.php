...
/* @var $searchModel common\models\BulkMailSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Bulk Mails');
$this->params['breadcrumbs'][] = $this->title;
?>
<?php Pjax::begin(); ?><div class="bulk-mail-index">
            ...
            ['class' => 'kartik\grid\ActionColumn',
             'template' => '{is-active} {update} {delete}',
                ...
                return Html::a('', 'index'.$string, [                                                  
                    ...
                    return Html::a('',['update', 'id'=>  common\components\GeneralComponent::encrypt($model->bulk_mail_id)],
				      ['class'=>'glyphicon glyphicon-pencil', 'data-pjax'=>0]);
            }, 
                            'delete' => function ($url, $model) {
                    return Html::a('', ['delete', 'id'=>  common\components\GeneralComponent::encrypt($model->bulk_mail_id)], ['class'=>'glyphicon glyphicon-trash',
