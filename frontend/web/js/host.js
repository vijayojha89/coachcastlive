...
(function() {
    ...
    var startBroadcast = function(session) {
        ...
        hideRtmpInput();
        http.post(BASE_URL + '/uploads/class_api/api.php', { action: 'start', sessionId: session.sessionId, streams: broadcast.streams, rtmp: rtmp })
    ...
    var endBroadcast = function(session) {
        http.post(BASE_URL + '/uploads/class_api/api.php', { action: 'end', session: session })
            .then(function() {
