    ...
    <div class="box-wrap wow fadeInUp"> 
        ...
        <div class="box-contan"> 
            ...
            <img class="img-circle" style="width:100px;height:100px;" src="<?php echo $gnl->image_not_found_hb($model->user->profile_photo, 'profile_photo',1); ?>" alt="User Avatar">
                ...
                <p>
                    <span style="text-align:right;"><a href="<?php echo Url::to(['trainer-class/broadcast', 'id' => \common\components\GeneralComponent::encrypt($model->trainer_class_id)]); ?>" class="btn btn-danger"><i class="fa fa-video-camera"></i>&nbsp;Start Class</a></span>
                </p>
             </div>
            <div class="box-right"> 
                ...
                <div class="tr-info">
                    <div class="video_edit class_prize">
                        ...
                        <?php if(\Yii::$app->user->identity->role == 'user'){ ?>
                           <!-- <a class="delete_vdo" title="Join"  href="<?php echo Url::to(['trainer-class/join', 'id' => \common\components\GeneralComponent::encrypt($model->trainer_class_id)]); ?>">Join <i class="fa fa-shopping-cart"></i></a>-->
                           <a class="delete_vdo" title="Detail"  href="<?php echo Url::to(['trainer-class/view', 'id' => \common\components\GeneralComponent::encrypt($model->trainer_class_id)]); ?>">Detail</a>
                        <?php }else{ ?>
