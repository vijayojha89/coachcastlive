                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        ...
                        <div class="whatclientsay">
                            <h2 class="section-title-default2 title-bar-high2">My Join Classes</h2>
                            ...
                            <?= 
                                    ListView::widget([
                                        ...
                                        'layout' => "\n{items}\n{pager}",
                                        'itemView' => '_myjoinclass_list_item',
                                    ]);
...
<div id="myModal" class="modal fade filterpopup" role="dialog">
 ...
 <?= $form->field($searchModel, 'title') ?>
	...
	?>
      ...
      <a class="btn btn-dark" href="<?php echo Url::to(['trainer-class/index']); ?>">Reset</a>
                            </div>
