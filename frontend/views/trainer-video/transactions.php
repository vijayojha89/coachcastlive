...
<div id="content" class="inner_container">
  <section class="contentsection">
    <div class="container">
         ...
         <div class="row">
                <div class="col-xs-6">
                    <h1 class="maintitle">Transactions</h1>
                </div>
                <div class="col-xs-6">
                        ...
                        <div class="trainers-filter-box">
                            ...
                            <form>                	
                                ...
                                <div class="form-group field-trainerclasssearch-workout_type_id">
                                    <label class="control-label" for="trainerclasssearch-workout_type_id">Type</label>
                                    <select class="form-control">
                                        <option value=""></option>
                                        <option value="1">Classes</option>
                                        <option value="2">Videos</option>
                                        <option value="3">Blog Subscription</option>
                                        <option value="3">Schedules</option>
                                    </select>
          ...
          <div class="pro-tabs-contant">
                        	 <div class="tabs-notification">
                                                ...
                                                <div class="info-box-contant">
													...
													<p>Join class - Easily Build Eight Packs At Online
</p>
<p>Transaction Id - #FitMakers001</p>
												</div>
												...
												<div class="info-box-contant">
													...
													<p>Purchase Video - Is Interval Cardio On A TreadMill Your 30 Minute Fat Loss</p>
                                                                                                        <p>Transaction Id - #FitMakers002</p>
												</div>
                                                <div class="notification_time"><i class="fa fa-clock-o"></i> 07/06/2017 10:14</div>
                                                <div class="schedule_brn_wrap">
                                                    <h4>Price <span>$18</span></h4>
                                                </div>
