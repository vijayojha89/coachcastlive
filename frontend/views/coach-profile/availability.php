                        ...
                        <div class="whatclientsay">
                            ...
                            <div class="panel panel-default">
                               ...
                               for ($m=date('m'); $m<=12; $m++) {
                                    ...
                                    echo '<label class="checkbox-inline checkboxbox"><input type="checkbox" name="monthselected[]" value="'.$m.'" '.$checked.' disabled><span class="checkmark"></span>'.$month.'</label>';
                                } ?>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                 ...
                                 foreach($days as $key => $value){
                                    ...
                                    echo '<label class="checkbox-inline checkboxbox"><input type="checkbox" name="dayselected[]" value="'.($key+1).'" '.$checked.'  disabled><span class="checkmark"></span>'.$value.'</label>'; 
                                 }
                                 ?>
