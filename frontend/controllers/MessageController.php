...
class MessageController extends Controller
{
    ...
    public function actionSendmessage($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $query = "SELECT * FROM message WHERE (from_id = '".$model->from_id."' AND to_id ='".$model->to_id."' ) OR (to_id = '".$model->from_id."' AND from_id ='".$model->to_id."' ) "; 
            $checkmessage = YII::$app->db->createCommand($query)->queryOne();
            if($checkmessage)
            {
                $conversation_id = $checkmessage['message_id'];
